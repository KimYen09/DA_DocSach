...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CommentViewHolder holder, int position) {
        ...
        // Hiển thị nút xóa nếu là comment của user hiện tại hoặc admin
        if (currentUser != null && (comment.getUserId().equals(currentUser.getUid()) || isAdmin())) {
    ...
    private boolean isAdmin() {
        ...
        // Có thể implement logic kiểm tra role từ Firebase
    ...
    static class CommentViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtUsername, txtTimestamp, txtCommentContent, txtLikeCount, txtReply, txtReport;
        ImageButton btnLikeComment, btnDeleteComment;
