...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.StoryViewHolder> {
    ...
    public StoryAdapter(Context context, List<Story> stories, OnStoryActionListener actionListener) {
    ...
    public static class StoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public StoryViewHolder(@NonNull View itemView) {
            super(itemView);
            titleTextView = itemView.findViewById(R.id.txtStoryTitle);
            category = itemView.findViewById(R.id.txtStoryCategory);
            imageView = itemView.findViewById(R.id.imgStory);
            btnEdit = itemView.findViewById(R.id.btnEditStory);
